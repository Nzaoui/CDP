  ...
  <div class="inner">
    ...
    <div class="left_nav">
      ...
      <div class="left_nav_slidebar">
        <ul>
          <li class="left_nav_active theme_border"><a href="index.html"><i class="fa fa-home"></i> Mon Profil <span class="left_nav_pointer"></span>  </a></li>
          <li> <a href="inscription.html"> <i class="fa fa-edit"></i> Créer un projet </a></li> 
          <li> <a href="login.html"> <i class="fa fa-tasks"></i> Tout les Projets </a></li>
