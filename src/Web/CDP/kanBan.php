    ...
    <div class="wrapper">
      ...
      <div class="inner">
        ...
        <div class="contentpanel">
         ...
         <div class="row center">
			<div class="col-lg-12 ">
				<img src="images/construction.png" class="img-responsive" alt="construction" style="margin: 0 auto; width: 30%"> 
				<img src="images/underconstruction.png" class="img-responsive" alt="construction" style="margin: 0 auto;"> 
			</div>
         </div>
